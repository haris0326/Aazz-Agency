<?php $__env->startSection('title', 'Package Inquiries'); ?>
<?php $__env->startSection('description', 'Manage and review customer package inquiries'); ?>
<?php $__env->startSection('topbar-title', 'Package Inquiries'); ?>
...
</style> <?php $__env->stopPush(); ?> <div class="ap-inquiries-page">
    

    <div class="ap-inquiries-header">
        <?php if (isset($component)) { $__componentOriginalcb19cb35a534439097b02b8af91726ee = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcb19cb35a534439097b02b8af91726ee = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => 'Package Inquiries','subtitle' => 'Manage and review customer inquiries for service packages','breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Package Inquiries','subtitle' => 'Manage and review customer inquiries for service packages','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
            ['label' => 'Dashboard', 'url' => route('admin.panel')],
            ['label' => 'Package Inquiries']
        ])]); ?>
...
<?php endif; ?>
    ...
    <div class="ap-inquiries-info">
        ...
        <div class="ap-inquiries-time">
            <?php echo e(\Carbon\Carbon::now('Asia/Karachi')->format('d M Y, h:i A')); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="ap-inquiry-contact">
                                ...
                                <a
                                    href="mailto:<?php echo e($inquiry->email); ?>"
                                ...
                                <?php if($inquiry->phone_number): ?>
                                <span class="ap-inquiry-phone">
                                    <i class="bi bi-telephone me-1"></i>
                                    <?php echo e($inquiry->phone_number); ?>
                        ...
                        <td>
                            ...
                            <?php if($inquiry->package): ?>

                            <span class="ap-inquiry-package">
                                <i class="bi bi-box-seam"></i>
                                <?php echo e($inquiry->package->level); ?>
                        ...
                        <td>
                            ...
                            <?php if($inquiry->category): ?>

                            <span class="ap-inquiry-category">
                                <?php echo e($inquiry->category->name); ?>
                        ...
                        <td>
                            ...
                            <?php if($inquiry->description): ?>

                            <span
                                class="ap-inquiry-description"
                                title="<?php echo e($inquiry->description); ?>">
                                <?php echo e(Str::limit(strip_tags($inquiry->description), 60)); ?>
                        ...
                        <td>
                            ...
                            <div class="ap-inquiry-actions">
                                ...
                                <a
                                    href="<?php echo e(route('admin.inquiries.view', $inquiry->id)); ?>"
                                ...
                                <a
                                    href="<?php echo e(route('inquiry.downloadPdf', $inquiry->id)); ?>"
...
<?php echo $__env->make(config('layout.admin_panel_layout'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel\Aazz-Agency\resources\views/admin_panel/packages/get_inquery/all_inquery.blade.php ENDPATH**/ ?>