    ...
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div class="hidden lg:flex items-center space-x-8 navbar-desktop-menu">
           ...
           <a href="<?php echo e(route('blogs.index')); ?>"
            class="nav-link-custom <?php echo e(request()->routeIs('blogs.index') || request()->routeIs('blog.show') ? 'active' : ''); ?>">
                Blog
            </a>
...
<div id="sidebar-menu" class="sidebar-menu">
    ...
    <div class="p-6">
        ...
        <ul class="space-y-4 text-lg">
            ...
            <li>
                <a href="<?php echo e(route('blogs.index')); ?>"
                class="block text-gray-800 hover:text-primary-blue transition-colors <?php echo e(request()->routeIs('blogs.index') || request()->routeIs('blog.show') ? 'text-primary-blue font-semibold' : ''); ?>">
                    Blog
                </a>
            </li>
