    ...
    <div class="max-w-7xl mx-auto px-6 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div class="space-y-6" data-aos="fade-up">
                <img 
                    src="<?php echo e(!empty($setting?->footer_logo) ? asset('storage/'.$setting->footer_logo) : asset('web_assets/images/web_logo/navbar_logo_1.png')); ?>"

                    alt="<?php echo e($setting->site_name ?? 'Aazz Agency'); ?>"
                ...
                <p class="leading-relaxed text-sm md:text-base">
                    <?php echo e($setting->footer_description ?? 'Empowering Digital Growth with Smart IT Solutions and innovative strategies. We build the future of digital experiences.'); ?>
            ...
            <div class="lg:pl-8" data-aos="fade-up" data-aos-delay="100">
                ...
                <ul class="space-y-4">
                    ...
                    <li>
                        <a href="<?php echo e(route('header_service.show', [$service->serviceCategory->cat_slug ?? '', $service->serviceSEO->meta_slug ?? ''])); ?>" 
            ...
            <div data-aos="fade-up" data-aos-delay="200">
                ...
                <ul class="space-y-4">
                    <?php $__empty_1 = true; $__currentLoopData = $webPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li>
                        <a href="<?php echo e(route('header_web_page.show', $page->slug)); ?>" 
                           class="group flex items-center hover:text-emerald-400 transition-all duration-300">
        ...
        <div class="mt-16 pt-8 border-t border-slate-800/60 flex flex-col md:flex-row justify-between items-center gap-6">
            <p class="text-sm text-slate-500">
                © <?php echo e(now()->year); ?> <span class="text-white font-semibold">Aazz Agency</span>. Crafted with <i class="fas fa-heart text-red-500 animate-pulse"></i> in Pakistan.
            </p>
...
</script><?php /**PATH D:\Laravel\Aazz-Agency\resources\views/partials/web_partial/footer.blade.php ENDPATH**/ ?>