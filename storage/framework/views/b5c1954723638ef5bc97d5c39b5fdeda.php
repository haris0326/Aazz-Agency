...
<?php $__env->startSection('description', 'Welcome to Aazz Agency Admin Panel'); ?>
...
<div class="ap-page-header">
    <div>
        ...
        <h3 class="mb-0">Welcome back, <?php echo e(Auth::user()->name); ?> 👋</h3>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="ap-stat-card">
            ...
            <div>
                ...
                <div class="ap-stat-value"><?php echo e($totalLeads ?? 0); ?></div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="ap-stat-card">
            ...
            <div>
                ...
                <div class="ap-stat-value"><?php echo e($totalPackagesInquiries ?? 0); ?></div>
                <a href="<?php echo e(route('admin.inquiries.index')); ?>" class="ap-stat-trend up text-decoration-none">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="ap-stat-card">
            ...
            <div>
                ...
                <div class="ap-stat-value"><?php echo e($members->count() ?? 0); ?></div>
                <a href="<?php echo e(route('team.index')); ?>" class="ap-stat-trend up text-decoration-none">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="ap-stat-card">
            ...
            <div>
                ...
                <a href="<?php echo e(route('admin.proposals.index')); ?>" class="ap-stat-trend up text-decoration-none">
...
<div class="ap-card mb-4">
    <div class="ap-card-header">
        ...
        <a href="<?php echo e(route('team.index')); ?>" class="btn btn-sm btn-outline-secondary">View All</a>
    </div>
        ...
        <table class="table ap-table mb-0">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr>
                        <td>
                            <img src="<?php echo e($avatar); ?>" alt="<?php echo e($member->name); ?>"
                                 style="width:38px;height:38px;border-radius:50%;object-fit:cover;" />
                        </td>
                        <td class="fw-semibold">
                            <a href="<?php echo e(route('team.show', $member->id)); ?>" class="text-dark text-decoration-none">
                                <?php echo e(\Str::limit($member->name, 20)); ?>

                            </a>
                        </td>
                        <td class="text-muted-ap"><?php echo e(\Str::limit($member->position, 20)); ?></td>
                        <td class="text-muted-ap"><?php echo e(\Str::limit($member->bio, 40)); ?></td>
                    </tr>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [4, 7, 6, 10, 8, <?php echo e($totalPackagesInquiries ?? 0); ?>],
                borderColor: '#4f46e5',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(config('layout.admin_panel_layout'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel\Aazz-Agency\resources\views/admin_panel/index.blade.php ENDPATH**/ ?>