...
class MainService extends Model
{
    ...
    {
        return $this->hasOne(HeroSection::class, 'main_service_id'); // Correct foreign key
    }
    ...
    {
        return $this->hasMany(AboutService::class, 'main_service_id', 'id');
    }
   // MainService.php
   public function tabContents()
   {
    ...
    {
        return $this->hasOne(ServiceDraft::class, 'service_id');
    }
