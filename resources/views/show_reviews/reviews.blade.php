                ...
                <div class="flex items-center gap-6 pt-4">
                    <div class="flex -space-x-3">
                        @foreach([1,2,3,4] as $i)
                            <img class="w-12 h-12 rounded-full border-4 border-white shadow-sm" src="https://i.pravatar.cc/150?u=a{{$i}}" alt="user">
                        @endforeach
                    </div>
                    <div>
                        ...
                        <div class="testimonial-item min-w-full px-2">
                            <div class="bg-white border border-slate-100 rounded-[2.5rem] p-8 md:p-14 shadow-[0_20px_50px_rgba(0,0,0,0.03)] hover:shadow-[0_40px_80px_rgba(0,0,0,0.06)] transition-shadow duration-500">
                                ...
                                <div class="flex items-center gap-5 pt-8 border-t border-slate-50">
                                    ...
                                    @endphp
                                    <img src="{{ $image }}" alt="{{ $review->user_name }}" class="w-16 h-16 rounded-2xl object-cover shadow-lg">
                                    <div>
                                        <h4 class="font-black text-slate-900 text-lg tracking-tight">{{ $review->user_name }}</h4>
