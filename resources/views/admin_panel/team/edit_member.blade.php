                        ...
                        <form action="{{ route('team.update', $member->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" name="facebook" class="form-control @error('facebook') is-invalid @enderror" id="facebook" value="{{ old('facebook', $member->facebook) }}">
                                </div>
                                @error('facebook')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" name="twitter" class="form-control @error('twitter') is-invalid @enderror" id="twitter" value="{{ old('twitter', $member->twitter) }}">
                                </div>
                                @error('twitter')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" name="linkedin" class="form-control @error('linkedin') is-invalid @enderror" id="linkedin" value="{{ old('linkedin', $member->linkedin) }}">
                                </div>
                                @error('linkedin')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" name="instagram" class="form-control @error('instagram') is-invalid @enderror" id="instagram" value="{{ old('instagram', $member->instagram) }}">
                                </div>
                                @error('instagram')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="role" class="form-control @error('role') is-invalid @enderror" id="role" value="{{ old('role', $member->role) }}" required>
                                </div>
                                @error('role')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
