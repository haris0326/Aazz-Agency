...
@section('description', 'Update package pricing, duration and included benefits')
@section('topbar-title', 'Edit Package')
...
<style>
...
</style> @endpush <div class="ap-package-page">
    <div class="ap-package-header">
        <x-admin.page-header
            title="Edit Package"
            subtitle="Update package pricing, duration and included services"
            :breadcrumbs="[
    ...
    <form
        action="{{ route('service.packages.update', $package->id) }}"
        method="POST"
        id="packageForm">
                    ...
                    <div class="ap-basic-grid">
                        ...
                        <div class="ap-field">
                            ...
                            <select
                                ...
                                <option
                                    value="{{ $category->id }}"
                                    {{ old('pkg_category_id', $package->pkg_category_id) == $category->id ? 'selected' : '' }}>
                                    {{ $category->name }}
                                </option>
                                @empty
                        ...
                        <div class="ap-field">
                            ...
                            <select
                                ...
                                <option
                                    value="{{ $duration }}"
                                    {{ old('duration', $package->duration) === $duration ? 'selected' : '' }}>
                                    {{ $duration }}
                                </option>
                    ...
                    <div class="ap-field">
                        ...
                        <div class="ap-benefits-wrapper">
                            ...
                            <div
                                ...
                                class="ap-benefits-container">

                                @php
                                $oldBenefits = old('benefits');

                                if ($oldBenefits === null) {
                                $oldBenefits = $package->benefits
                                ->pluck('benefit_description')
                                ->toArray();
                                }

                                if (empty($oldBenefits)) {
                                $oldBenefits = [''];
                                }
                                @endphp
                            ...
                            <div class="ap-field-help">
                                Update or add the services included in this package.
                            </div>
                    ...
                    <div class="ap-package-card-body">
                        ...
                        <div class="ap-preview">
                            ...
                            <p class="ap-preview-text">
                                Review the package level, duration, price and
                                included services before saving your changes.
                            </p>
                    ...
                    <div class="ap-package-card-body">
                        ...
                        <ul class="ap-info-list">
                            ...
                            <li class="ap-info-item">
                                <i class="bi bi-check-circle-fill"></i>
                                <span>
                                    Keep the package level clear and consistent.
                                </span>
                            </li>
                            ...
                            <li class="ap-info-item">
                                <i class="bi bi-check-circle-fill"></i>
                                <span>
                                    Verify the price and billing duration.
                                </span>
                            </li>
                            ...
                            <li class="ap-info-item">
                                <i class="bi bi-check-circle-fill"></i>
                                <span>
                                    Make sure all important services are included.
                                </span>
                            </li>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateBenefitNumbers() {
            ...
            const removeButtons =
                benefitsContainer.querySelectorAll('.remove-benefit');
        ...
        benefitsContainer.addEventListener('click', function(event) {
            ...
            const rows =
                benefitsContainer.querySelectorAll('.benefit-field');
