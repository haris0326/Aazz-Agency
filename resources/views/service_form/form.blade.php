...
<section id="proposal-form" class="py-20 bg-gradient-to-r from-blue-600 to-teal-400">
  <div class="container mx-auto px-4">
    ...
    <form id="proposalForm" action="{{ route('proposals.store') }}" method="POST"
          class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6" data-aos="fade-up" novalidate>
      @csrf

      {{-- Honeypot: invisible to humans, bots auto-fill every field --}}
      ...
      {{-- Human verification --}}
      <div>
        <div class="g-recaptcha" data-sitekey="{{ config('services.recaptcha.site_key') }}" data-callback="onProposalCaptchaVerified" data-expired-callback="onProposalCaptchaExpired"></div>
